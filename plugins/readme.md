...
说明: Port of IntelliJ IDEA Keybindings, including for WebStorm, PyCharm, PHP Storm, etc.
版本: 0.2.37
发布者: Keisuke Kato
VS Marketplace 链接: https://marketplace.visualstudio.com/items?itemName=k--kato.intellij-idea-keybindings
```
## 文件大小
```
名称: filesize
...
名称: React Redux ES6 Snippets
id: timothymclane.react-redux-es6-snippets
说明: ES6 Snippets with arrow functions for React-Redux
版本: 2.1.0
发布者: Timothy McLane
VS Marketplace 链接: https://marketplace.visualstudio.com/items?itemName=timothymclane.react-redux-es6-snippets
```
